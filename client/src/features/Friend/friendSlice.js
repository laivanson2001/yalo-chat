...
const friendSlice = createSlice({
	...
	extraReducers: (builder) =>
		builder
			...
			.addCase(fetchListRequestFriend.pending, (state, action) => {
				state.isLoading = true;
			})
			.addCase(fetchListRequestFriend.rejected, (state, action) => {
				state.isLoading = false;
			})
			...
			.addCase(fetchListMyRequestFriend.pending, (state, action) => {
				state.isLoading = true;
			})
			.addCase(fetchListMyRequestFriend.rejected, (state, action) => {
				state.isLoading = false;
			})
			...
			.addCase(fetchListGroup.rejected, (state, action) => {
				state.isLoading = false;
			})
			.addCase(fetchListGroup.pending, (state, action) => {
				state.isLoading = true;
			})
			...
			.addCase(fetchSuggestFriend.rejected, (state, action) => {
				state.isLoading = false;
			})
			.addCase(fetchSuggestFriend.pending, (state, action) => {
				state.isLoading = true;
			}),
});

...
const Chat = ({ socket, idNewMessage }) => {
								...
								<div className='landing-app'>
									<div className='title-welcome'>
										<div className='title-welcome-heading'>
											<span>
												Chào mừng đến với <b>Yalo</b>
											</span>
										</div>

										<div className='title-welcome-detail'>
											<span>
												Khám phá những tiện ích hỗ trợ
												làm việc và trò chuyện cùng
												người thân, bạn bè được tối ưu
...
Chat.propTypes = { socket: PropTypes.object, idNewMessage: PropTypes.string };

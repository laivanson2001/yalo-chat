...
const ModalViewOption = ({ isModalVisible, onCancel, data, onShowDetail }) => {
		...
		>
			<div className='modal-view-option'>
				<div className='modal-view-option_title'>
					...
					<small>
						Tạo bởi <strong>{infoVote?.user?.name}</strong> - Hôm
						qua
					</small>
				</div>
